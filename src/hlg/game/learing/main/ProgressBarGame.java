...
public class ProgressBarGame implements ApplicationListener {
	...
	public class ProgressBar extends Actor implements Disposable {
		...
		public void draw(SpriteBatch batch, float parentAlpha) {
			...
			batch.draw(bar,(Gdx.graphics.getWidth()-bar.getWidth()*powerx)/2 + 40, -13,bar.getWidth()*progress/100f*powerx,bar.getHeight()*powery);
